      ...
      <div>
        <nav class="flex flex-row justify-between p-5">
          ...
          <ul class="flex flex-row justify-items-center rounded-xl">
            ...
            <li><a class="hover-effect p-2 bg-white rounded-tr-xl rounded-br-xl" href="#"><span>Contact</span></a></li>
          </ul>
        </nav>
        <div class="bg-white">
          <header>
            <ul class="flex flex-row">
              <li class="hover-effect px-2 py-2">Sign-up</li>
              <li class="hover-effect px-2 py-2">Log-in</li>
            </ul>
          </header>
