...
<main class="px-2 py-4">
  ...
  <article class="bg-orange-500 px-3 py-5">
    <p class="text-justify mb-8">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Vero voluptate, at voluptatem dolorem quidem quam possimus adipisci libero quo harum itaque vel iste, sint animi commodi voluptatum sunt id fugiat.</p>
    <nav>
      <ul class="flex flex-row justify-items-center justify-center">
        ...
        <li><a class="hover-effect px-3 py-2 bg-white rounded-tr-xl rounded-br-xl" href="lista_receitas.php">listar receitas</a></li>
      </ul>
    </nav>
  </article>
</main>
